        ...
        <center>
            <div class="card col-md-7 mt-3">
                <div class="card-header">
                    <form action="/" method="GET" class="col-md-12" style="height: 41px;display: flex;flex-direction: row;">
                        @csrf
                  ...
                  <div class="card-header row">
                    ...
                    <div class="col-md-5">
                      <form action="/notas" method="GET">
                        <input type="text" id="search" name="search" class="form-control" placeholder="Ex. CNPJ, UF, Descrição...">
                      </form>
                    </div>
                  </div>
                                      ...
                                      <td>
                                        ...
                                        position:absolute;display:none; margin-top:20px">
                                          <div class="text-center">
                                            <input type="text" name="texto" class="texto" id="texto{{$nfe->id}}" style="position:relative; top:-800px;" readonly value="{{ $nfe->id }}" />
